JEIEvents.information(event => {
    ...
    event.addItem('kubejs:unipolar_magnet_shard', Text.black({"translate": "kubejs.jei.unipolar_magnet"}))
    ...
    event.addItem('obscure_api:astral_dust', Text.black({"translate": "kubejs.jei.astral_dust"}))
    event.addItem('cti:upgrade_augment_9', Text.black({"translate": "kubejs.jei.upgrade_argument9"}))
})
