ServerEvents.recipes(event => {
    event.smelting('ae2:certus_quartz_crystal', 'ae2:printed_calculation_processor')
    event.smelting('minecraft:gold_ingot', 'ae2:printed_logic_processor')
    event.smelting('minecraft:diamond', 'ae2:printed_engineering_processor')
    ...
    event.custom(
        {
            ...
            "result": {
                "item": 'tinkerscalibration:glass_silk',
                "count": 2
            },
        })
})
