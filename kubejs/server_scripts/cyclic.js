ServerEvents.recipes(event => {
    ...
    event.replaceInput({
        mod: 'cyclic',
        id: 'cyclic:charm_invisible'
    }, 'cyclic:sleeping_mat', 'etshtinker:lightless_alloy')
    event.replaceInput({
        mod: 'cyclic',
        id: 'cyclic:wireless_fluid'
    }, 'cyclic:gem_amber', 'tinkers_thinking:tinkers_bronze_ingot')
