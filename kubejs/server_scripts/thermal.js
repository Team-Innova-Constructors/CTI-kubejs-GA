ServerEvents.recipes(event => {
  ...
  event.recipes.thermal.pulverizer([Item.of('minecraft:diamond').withChance(0.3), Item.of('powah:uraninite_raw').withChance(0.2), Item.of('minecraft:lapis_lazuli').withChance(1.2), Item.of('minecraft:emerald').withChance(0.6)], 'kubejs:crystal_slag').energy(30000)
  ...
  event.recipes.thermal.pulverizer([Item.of('etshtinker:bismuthinite').withChance(0.15), Item.of('thermal:cinnabar').withChance(0.8), Item.of('thermal:niter').withChance(0.9), Item.of('thermal:apatite').withChance(0.8)], 'kubejs:mineral_slag').energy(30000)
  ...
  event.recipes.thermal.crystallizer('create:andesite_casing', ['#minecraft:logs','create:andesite_alloy', Fluid.of("cti:lava_overheated", 50)]).energy(2000)
  event.recipes.thermal.crystallizer('create:brass_casing', ['#minecraft:logs','create:brass_ingot', Fluid.of("cti:lava_overheated", 50)]).energy(2000)
  event.recipes.thermal.crystallizer('create:copper_casing', ['#minecraft:logs','minecraft:copper_ingot', Fluid.of("cti:lava_overheated", 50)]).energy(2000)
  event.recipes.thermal.crystallizer('create:andesite_casing', ['thermal:stripped_rubberwood_log','create:brass_ingot', Fluid.of("cti:lava_overheated", 50)]).energy(2000)
  event.recipes.thermal.crystallizer('create:brass_casing', ['thermal:stripped_rubberwood_log','create:brass_ingot', Fluid.of("cti:lava_overheated", 50)]).energy(2000)
  event.recipes.thermal.crystallizer('create:copper_casing', ['thermal:stripped_rubberwood_log','minecraft:copper_ingot', Fluid.of("cti:lava_overheated", 50)]).energy(2000)
...
//有机灌注器
  ...
  event.recipes.thermal.centrifuge([Item.of('kubejs:light_slag').withChance(0.3), Item.of('kubejs:crystal_slag').withChance(0.3), Item.of('kubejs:metal_slag').withChance(0.1), Item.of('kubejs:mineral_slag').withChance(0.3)], 'kubejs:enriched_slag').energy(12000)
  event.recipes.thermal.centrifuge([Item.of('kubejs:powdered_slag').withChance(0.35), Item.of('minecraft:coal').withChance(0.85), Item.of('thermal:raw_nickel').withChance(0.12), Item.of('immersiveengineering:dust_aluminum').withChance(0.15)], 'kubejs:light_slag').energy(12000)
  event.recipes.thermal.centrifuge([Item.of('thermal:gold_dust').withChance(2.1), Item.of('thermal:silver_dust').withChance(1.5), Item.of('mekanism:dust_osmium').withChance(1.3), Item.of('mekanism:dust_uranium').withChance(1.2)], 'kubejs:dense_slag').energy(12000)
  event.recipes.thermal.centrifuge([Item.of('minecraft:redstone').withChance(1.5), Item.of('minecraft:glowstone_dust').withChance(1.1), Item.of('thermal:quartz_dust').withChance(0.9), Item.of('2x minecraft:clay_ball').withChance(0.3)], 'kubejs:powdered_slag').energy(12000)
  //催化剂
