ServerEvents.recipes(event => {
  ...
  event.recipes.thermal.crystallizer('create:andesite_casing', ['#minecraft:logs','create:andesite_alloy', Fluid.of("cti:lava_heated", 100)]).energy(2000)
  event.recipes.thermal.crystallizer('create:brass_casing', ['#minecraft:logs','create:brass_ingot', Fluid.of("cti:lava_heated", 100)]).energy(2000)
  event.recipes.thermal.crystallizer('create:copper_casing', ['#minecraft:logs','minecraft:copper_ingot', Fluid.of("cti:lava_heated", 100)]).energy(2000)
  event.recipes.thermal.crystallizer('create:andesite_casing', ['thermal:stripped_rubberwood_log','create:brass_ingot', Fluid.of("cti:lava_heated", 90)]).energy(2000)
  event.recipes.thermal.crystallizer('create:brass_casing', ['thermal:stripped_rubberwood_log','create:brass_ingot', Fluid.of("cti:lava_heated", 90)]).energy(2000)
  event.recipes.thermal.crystallizer('create:copper_casing', ['thermal:stripped_rubberwood_log','minecraft:copper_ingot', Fluid.of("cti:lava_heated", 90)]).energy(2000)
