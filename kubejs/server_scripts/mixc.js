ServerEvents.recipes(event => {
    ...
    event.replaceInput({
        ...
        type: 'crafting_shaped',
        output: 'pipez:advanced_upgrade'
    }, 'minecraft:diamond', 'minecraft:lapis_lazuli')
    event.replaceInput({
        mod: 'pipez',
        type: 'crafting_shaped',
    ...
    event.replaceInput({
        ...
        type: 'crafting_shaped',
        output: 'pipez:ultimate_upgrade'
    }, 'minecraft:netherite_ingot', 'tinkers_thinking:obsidian_bronze_ingot')
    event.replaceInput({
    ...
    //精妙升级
    event.shaped(Item.of('sophisticatedstorage:basic_to_gold_tier_upgrade', 1), [
            'BBB',
            'BAB',
            'BBB'
        ],
        {
            B: 'tinkers_thinking:tinkers_bronze_ingot',
            A: 'extendedcrafting:redstone_ingot',
        }
    )
    event.shaped(Item.of('sophisticatedstorage:basic_to_diamond_tier_upgrade', 1), [
            'BBB',
            'BAB',
            'BBB'
        ],
        {
            ...
            A: 'sophisticatedstorage:basic_to_gold_tier_upgrade',
        }
    )
    event.shapeless(Item.of('sophisticatedstorage:basic_to_netherite_tier_upgrade', 1), [
            'sophisticatedstorage:basic_to_diamond_tier_upgrade',
            'tconstruct:hepatizon_ingot',
        ]
    )
    event.shaped(Item.of('sophisticatedstorage:iron_to_gold_tier_upgrade', 1), [
            'BBB',
            'BAB',
            'BBB'
        ],
    ...
    event.shaped(Item.of('sophisticatedstorage:iron_to_diamond_tier_upgrade', 1), [
            'BBB',
            'BAB',
            'BBB'
        ],
    ...
    event.shapeless(Item.of('sophisticatedstorage:iron_to_netherite_tier_upgrade', 1), [
            'sophisticatedstorage:iron_to_diamond_tier_upgrade',
            'tconstruct:hepatizon_ingot',
        ]
    )
    event.shaped(Item.of('sophisticatedstorage:gold_to_diamond_tier_upgrade', 1), [
            'BBB',
            'BAB',
            'BBB'
        ],
    ...
    event.shapeless(Item.of('sophisticatedstorage:gold_to_netherite_tier_upgrade', 1), [
            'sophisticatedstorage:gold_to_diamond_tier_upgrade',
            'tconstruct:hepatizon_ingot',
        ]
    )
    event.shapeless(Item.of('sophisticatedstorage:diamond_to_netherite_tier_upgrade', 1), [
    ...
    event.shaped(Item.of('sophisticatedstorage:stack_upgrade_tier_4', 1), [
        ...
        {
            B: 'tconstruct:amethyst_bronze_ingot',
            C: 'tconstruct:amethyst_bronze_block',
            A: 'sophisticatedstorage:stack_upgrade_tier_3',
        }
    )
    event.shaped(Item.of('sophisticatedstorage:stack_upgrade_tier_3', 1), [
            'BBB',
            'BAB',
            'CBC'
        ],
        {
            B: 'tinkers_thinking:tinkers_bronze_ingot',
            C: 'tinkers_thinking:tinkers_bronze_block',
            A: 'sophisticatedstorage:stack_upgrade_tier_2',
        }
    )
    ...
    event.shaped(Item.of('l2complements:shulkerate_ingot', 3), [
        ...
        ],
        {
            ...
            A: 'solidarytinker:heavy_armor_steel_ingot',
            D: 'l2complements:captured_shulker_bullet',
        }
    )
