ServerEvents.recipes(event => {
    ...
    if (cast !== null) {
        recipe["cast"] = cast.startsWith('#') ? {"tag": cast.substring(1)} : {"item": cast};
        recipe["cast_consumed"] = consumeCast;
    }
    event.custom(recipe);
}
    ...
    addAlloy([
        {fluid: "tconstruct:venom", amount: 250},
    ...
    addMelting("aether:valkyrie_leggings", "kubejs:molten_valkyrie", 5670, 3250, 175)
    addMelting('aether:valkyrie_cape', "kubejs:molten_valkyrie", 4860, 3250, 175)
    addMelting("aether:valkyrie_hoe", "kubejs:molten_valkyrie", 1620, 3250, 100)
    addMelting("aether:valkyrie_axe", "kubejs:molten_valkyrie", 2430, 3250, 100)
    ...
    addMelting('biomancy:absorption_boost', "kubejs:molten_absorption_boost", 250, 1230, 100)
    ...
    addMelting('minecraft:redstone_block', "thermal:redstone", 900, 1500, 100)
    addMelting('minecraft:redstone', "thermal:redstone", 100, 1500, 50)
    ...
    addMelting("aether:neptune_boots", "tcintegrations:neptunium", 3240, 2100, 100)
    addMelting("aether:neptune_helmet", "tcintegrations:neptunium", 4050, 2100, 100)
    addMelting("aether:neptune_chestplate", "tcintegrations:neptunium", 6480, 2100, 100)
    addMelting("aether:neptune_leggings", "tcintegrations:neptunium", 5670, 2100, 100)
    addMelting("aether:neptune_gloves", "tcintegrations:neptunium", 1620, 2100, 100)
    ...
    addMelting("aether:gravitite_hoe", "kubejs:molten_gravitite", 180, 4950, 100)
    addMelting("aether:gravitite_shovel", "kubejs:molten_gravitite", 90, 4950, 100)
    addMelting("aether:gravitite_axe", "kubejs:molten_gravitite", 270, 4950, 100)
